...
public class Rotor extends Permutator {
	...
	public static final Rotor ROTOR_I = new Rotor(new char[] { 'E', 'K', 'M', 'F', 'L', 'G', 'D', 'Q', 'V', 'Z', 'N',
			'T', 'O', 'W', 'Y', 'H', 'X', 'U', 'S', 'P', 'A', 'I', 'B', 'R', 'C', 'J' });
	public static final Rotor ROTOR_II = new Rotor(new char[] { 'A', 'J', 'D', 'K', 'S', 'I', 'R', 'U', 'X', 'B', 'L',
			'H', 'W', 'T', 'M', 'C', 'Q', 'G', 'Z', 'N', 'P', 'Y', 'F', 'V', 'O', 'E' });
	public static final Rotor ROTOR_III = new Rotor(new char[] { 'B', 'D', 'F', 'H', 'J', 'L', 'C', 'P', 'R', 'T', 'X',
			'V', 'Z', 'N', 'Y', 'E', 'I', 'W', 'G', 'A', 'K', 'M', 'U', 'S', 'Q', 'O' });
	public static final Rotor ROTOR_IV = new Rotor(new char[] { 'E', 'S', 'O', 'V', 'P', 'Z', 'J', 'A', 'Y', 'Q', 'U',
			'I', 'R', 'H', 'X', 'L', 'N', 'F', 'T', 'G', 'K', 'D', 'C', 'M', 'W', 'B' });
	public static final Rotor ROTOR_V = new Rotor(new char[] { 'V', 'Z', 'B', 'R', 'G', 'I', 'T', 'Y', 'U', 'P', 'S',
			'D', 'N', 'H', 'L', 'X', 'A', 'W', 'M', 'J', 'Q', 'O', 'F', 'E', 'C', 'K' });
	public static final Rotor ROTOR_VI = new Rotor(new char[] { 'J', 'P', 'G', 'V', 'O', 'U', 'M', 'F', 'Y', 'Q', 'B',
			'E', 'N', 'H', 'Z', 'R', 'D', 'K', 'A', 'S', 'X', 'L', 'I', 'C', 'T', 'W' });
	public static final Rotor ROTOR_VII = new Rotor(new char[] { 'N', 'Z', 'J', 'H', 'G', 'R', 'C', 'X', 'M', 'Y', 'S',
			'W', 'B', 'O', 'U', 'F', 'A', 'I', 'V', 'L', 'P', 'E', 'K', 'Q', 'D', 'T' });
	public static final Rotor ROTOR_VIII = new Rotor(new char[] { 'F', 'K', 'Q', 'H', 'T', 'L', 'X', 'O', 'C', 'B', 'J',
			'S', 'P', 'D', 'Z', 'R', 'A', 'M', 'E', 'W', 'N', 'I', 'U', 'Y', 'G', 'V' });
	public static final Rotor ROTOR_BETA = new Rotor(new char[] { 'L', 'E', 'Y', 'J', 'V', 'C', 'N', 'I', 'X', 'W', 'P',
			'B', 'Q', 'M', 'D', 'R', 'T', 'A', 'K', 'Z', 'G', 'F', 'U', 'H', 'O', 'S' });
	public static final Rotor ROTOR_GAMMA = new Rotor(new char[] { 'F', 'S', 'O', 'K', 'A', 'N', 'U', 'E', 'R', 'H',
			'M', 'B', 'T', 'I', 'Y', 'C', 'W', 'L', 'Q', 'P', 'Z', 'X', 'V', 'G', 'J', 'D' });
	 ...
	 */
	public void rotate() {
		// Increment position by one, bending round to the 'A' at 'Z'
		// NIFQFHKBUGQRAFRU
		if (++position > 'Z')
			position = 'A';
	...
	public void printKey() {
		...
		for (int i = 0; i < permutation.length; i++) {
			System.out.println(i + ".................." + permutation[i] + " - " + i + ".................."
					+ invertedPermutation[i]);
		}
	}
}
